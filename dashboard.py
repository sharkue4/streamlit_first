...
timely_complaints_ratio = (timely_complaints/total_complaints)*100
...
col4.metric("Timely Complaints %%", str(timely_complaints_ratio)+'%')
col5.metric("In Progress Complaints",in_progess_complaints)
